...
import bgImage from '../assets/background.webp';  // Ensure this path is correct
import logo from '../assets/logo.webp';           // Ensure this path is correct

const LoginPage = () => {
  return (
    <section className="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center bg-cover bg-center relative"
